...
#, gnome/*.gnome-shell*/
, browserpass, uget-integrator, plasma5Packages, bukubrow, pipewire
, tridactyl-native
, fx-cast-bridge
, keepassxc
, udev
    ...
    let
      ...
      allNativeMessagingHosts = builtins.map lib.getBin (
        nativeMessagingHosts
          ...
          ++ deprecatedNativeMessagingHost "enableGnomeExtensions" false #gnome-browser-connector
      ...
      libs =   lib.optionals stdenv.isLinux [ udev libva mesa libnotify xorg.libXScrnSaver pciutils ]
