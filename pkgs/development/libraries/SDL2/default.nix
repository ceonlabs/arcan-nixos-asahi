...
, ibusSupport ? false
, ibus
, libdecorSupport ? false # stdenv.isLinux && !stdenv.hostPlatform.isAndroid
#, libdecor
, pipewireSupport ? false # stdenv.isLinux && !stdenv.hostPlatform.isAndroid
#, pipewire # NOTE: must be built with SDL2 without pipewire support
, pulseaudioSupport ? false # config.pulseaudio or stdenv.isLinux && !stdenv.hostPlatform.isAndroid
, libpulseaudio
, AudioUnit
, Cocoa
, CoreAudio
