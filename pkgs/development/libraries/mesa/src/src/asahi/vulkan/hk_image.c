   ...
   VkImageFormatProperties2 *pImageFormatProperties)
{
   ...
   vk_foreach_struct(s, pImageFormatProperties->pNext) {
      ...
      default:
         hk_debug_ignored_stype(s->sType);
         break;
      }
   }
                                 ...
                                 VkMemoryRequirements2 *pMemoryRequirements)
{
   ...
   vk_foreach_struct_const(ext, pMemoryRequirements->pNext) {
      ...
      default:
         hk_debug_ignored_stype(ext->sType);
         break;
      }
   }
}
                                ...
                                VkSubresourceLayout2KHR *pLayout)
{
   ...
   pLayout->subresourceLayout = (VkSubresourceLayout){
      ...
      /* TODO: we can't get a single mip level but I think that's ok? */
      .size = plane->layout.layer_stride_B,
